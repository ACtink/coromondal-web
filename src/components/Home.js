...
function Home() {
  ...
  const [showSecondGrandPage, setShowSecondGrandPage ,showGrandPage2 , setShowgrandPage2 ] = useContext(ShowNewGrandPageContext);
  ...
  return (
    ...
    <div className="outer">
      ...
      <div className="nav-buttons-container">
        ...
        <img src="/requirements/backgrounds/home-up.gif" className="banner-image" alt="" />
      </div>
      {/* <div className="home-down-portion"> */}

      <div className="card-container">

      <img className="home-down-image" src="/requirements/backgrounds/home-down.gif" alt="" />
